lib.callback.register('dolu_tool:getVersion', function()
    local resource = 'dolu_tool'
    local repository = "dolutattoo/dolu_tool"
    ...
    local timeout = 0
    while not data or timeout == 500 do Wait(0); timeout += 1 end
    return data or { currentVersion = currentVersion }
end)